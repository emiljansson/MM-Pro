...
interface HomeLayoutAndroidProps {
  // Theme & Translation
  theme: any;
  t: (key: string) => string;
...
export const HomeLayoutAndroid: React.FC<HomeLayoutAndroidProps> = ({
  theme,
  t,
  isSmallScreen,
  isCompact,
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        {/* Title - Android specific styling */}
        <View style={[
        ...
        <View style={[
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        styles.categoryCard,
                        {
                          ...
                          elevation: selectedCategory?.key === category.key ? 4 : 1,
                        },
                      ]}
                    >
                      <View style={[
          ...
          {/* Navigation - Android positioned lower */}
          <View style={styles.navigationContainer}>
            <TouchableOpacity
              ...
              style={[
                styles.navArrow,
                { backgroundColor: theme.surface, elevation: 2 },
      ...
      {/* Fixed Bottom Section - Android with elevation */}
      <View style={[
        styles.fixedBottomSection,
        { backgroundColor: theme.background, elevation: 8 },
        isTablet && { paddingHorizontal: 24 }
      ]}>
        {/* Difficulty */}
        ...
        {/* Start Button - Android Material style */}
        <TouchableOpacity
          style={[
            styles.startButton,
