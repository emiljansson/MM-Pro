...
export default function HomeScreen() {
  ...
  const renderCategoryCard = (category: typeof ALL_CATEGORIES[0], index: number) => {
    ...
    // Android: 1.3, iOS: 1.2 (taller cards)
    const cardAspectRatio = isTablet ? undefined : Platform.OS === 'android' ? 1.3 : 1.2;
      ...
      <View style={styles.centeredWrapper}>
        ...
        >
          ...
          <View style={[
            ...
            >
              <Text style={{ fontWeight: '400', color: theme.text }}>{t('app_title_part1')}</Text>
              <Text style={{ fontWeight: '800', color: theme.primary }}>{t('app_title_part2')}</Text>
            </Text>
            <Text style={[
              styles.tagline, 
